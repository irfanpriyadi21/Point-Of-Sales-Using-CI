                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <?php if($tampil['status_order'] == "Lunas"):?>
                                                                <a class="btn btn-primary" href="<?= base_url()?>kasir/c_transaksi/faktur/<?= $tampil['id_order']?>">
                                                                    <i class="material-icons">print</i>
                                                                </a>
                                                            <?php else:?>
                                                            <a class="btn btn-danger" href="<?= base_url()?>kasir/c_transaksi/view/<?= $tampil['id_order']?>">
