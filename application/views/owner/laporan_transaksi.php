                            ...
                            <form class action="" method="post">
                                <div class="row clearfix">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <a class="btn btn-warning" href="<?= base_url() ?>owner/c_laporan">Reset</a>
                                        <a class="btn btn-success" href="<?= base_url() ?>owner/c_laporan/print_laporan?<?= (@$mulai ? "mulai=$mulai&selesai=$selesai" : '') ?>">Print</a>
                                    </div>
                                    <div class="col-md-12">
