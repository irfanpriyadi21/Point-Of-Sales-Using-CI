                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <?php if($view1['status_order'] == "Lunas"):?>
                                                           Sudah Lunas
                                                        <?php else:?>
                                                            <a class="btn btn-danger" onclick="return confirm('yakin ingin di hapus ??')" href="<?= base_url()?>pelanggan/c_order/hapus_order/<?= $tampil['id_detail_order']?>?id=<?= $view1['id_order']?>">
