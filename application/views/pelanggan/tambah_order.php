                                ...
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                 <a class="btn btn-danger" href="<?= base_url()?>pelanggan/c_order/hapus/<?= $tampil['id_order']?>"
                                                 onclick="return confirm('yakin ingin di hapus ??')">
                                                     <i class="material-icons">delete</i>
                                                  </a>
                                                  <a class="btn btn-primary" href="<?= base_url()?>pelanggan/c_order/view/<?= $tampil['id_order']?>">
